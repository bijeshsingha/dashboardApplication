  ...
  return (
    <div className="mt-12">
          ...
          {earningData.map((item) => (
            ...
            >
              <button
                ...
                className="text-xl opacity-0.9 rounded-full p-4 hover:drop-shadow-xl"
              >
                {item.icon}
              </button>
              <p className="mt-3">
      ...
      <div className="flex flex-wrap gap-10 justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl m-3 md:w-780 p-4">
